...
class MidpointDisplacementView(AlgorithmView):
    ...
    def create_section_configuration(self, root):
        ...
        # Add double entries
        self.mv.create_dual_entry(root, "Start (x, y)", self.entry_start_x, self.entry_start_y, def_val_1=1, def_val_2=1) 
        self.mv.create_dual_entry(root, "End (x, y)",   self.entry_end_x, self.entry_end_y, def_val_1=self.mv.get_entry_width()-1, def_val_2=self.mv.get_entry_height()-1)
